...
for mc_idx1 = 1:N_MC1
    ...
    for mc_idx2 = 1:N_MC2
        ...
        x_normalized = normalize_decoded_signal(receiver, decoder_type, M, s, N_SNR);
...
save(fullfile(simulation_dir, file_name), 'M', 'K', 'SNR', 'BER', 'N_AMP', 'N_A0', 'A0', 'decoder_type', 'amplifiers_type', 'N_params');